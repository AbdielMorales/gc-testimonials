<script src="https://www.google.com/recaptcha/api.js?render=6Lc0HEIaAAAAANC1fRzA0UfvhzI0mNQV_9s6hybL"></script>
<?php
if(isset($_POST) && isset($_POST["gct_submit_testimonial"]))
{
echo "<pre>";
print_r($_POST);
echo "</pre>";
...
<script>
      function onClick(e) {
          ...
          grecaptcha.execute('6Lc0HEIaAAAAANC1fRzA0UfvhzI0mNQV_9s6hybL', {action: 'submit'}).then(function(token) {
		  //console.log(token);
